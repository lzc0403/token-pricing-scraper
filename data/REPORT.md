...
| DeepSeek V4 Pro | openrouter | 5.53216 ¥ | 11.0643 ¥ | 0.065859 USD | USD | 0.790308 USD / 1.58062 USD | 1.04858M |
...
| 模型 | 源 | 字段 | 旧值 | 新值 | 货币 |
| --- | --- | --- | ---: | ---: | --- |
| DeepSeek V4 Pro | openrouter | 输入 | 0.522 | 0.790308 | USD |
| DeepSeek V4 Pro | openrouter | 输出 | 1.044 | 1.58062 | USD |
| DeepSeek V4 Flash | openrouter | 输入 | 0.056 | 0.088606 | USD |
| DeepSeek V4 Flash | openrouter | 输出 | 0.112 | 0.177212 | USD |
| GLM-5.2 | openrouter | 输入 | 0.966 | 1.19 | USD |
| GLM-5.2 | openrouter | 输出 | 3.036 | 3.74 | USD |
