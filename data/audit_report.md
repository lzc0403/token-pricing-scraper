...
> 生成时间：2026-07-19 02:03:51

## 一、核对统计

- 校验记录总数：**37**
- 可疑项总数：**36**（high 6 / med 0 / low 30）
- Tier1 结构性校验可疑：**0**
- Tier2 源页面核对可疑：**36**
...
| high | T2 | PRICE_NOT_FOUND | openrouter | GLM-5.2 | 静态源页面未找到input价数值「0.2912」，疑似解析/幻觉错误 |
| high | T2 | PRICE_NOT_FOUND | openrouter | GLM-5.2 | 静态源页面未找到output价数值「0.9152」，疑似解析/幻觉错误 |
