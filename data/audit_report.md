...
| med | T1 | CACHE_RATIO_ANOMALY | openrouter | Kimi K3 | 缓存/输入比率(12%) 偏离同模型基准(10%) 超 15%，疑似缓存价缺失/估算口径不一致 |
| med | T1 | DUPLICATE | kimi | - | 重复记录 ×3: kimi-k2.6 |
| med | T1 | DUPLICATE | kimi | - | 重复记录 ×3: kimi-k2.7-code |
